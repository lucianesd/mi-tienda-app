    ...
    <div className="bg-gradient-to-r from-blue-600 to-green-600 text-white px-6 py-10 mx-4 mt-2 rounded-lg shadow-lg">
      <div className="container mx-auto flex items -center justify-between">
        <div className="flex-1">
          ...
          <div className="flex">
            <div className="bg-white text-blue-950 py-4 px-6 rounded-full shadow-md transform hover:scale-105 transition duration-300">
              ...
              <span className="ml-2 font-bold text-base sm:text-xl">
                para obtener {promocion.descuento}% de descuento.
              </span>
            </div>
          </div>
        </div>
